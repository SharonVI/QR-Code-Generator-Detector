...
def close_window():
    ...
    if askyesno(title='Close R4V3N QR Code Generator-Detector', message='Are you sure you want to close the application?'):
...
window.title('QR Code Generator-Detector By R4V3N')
